...
<body class="bg-gray-100">
    <div class="container mx-auto mt-10">
        ...
        <div class="max-w-md mx-auto bg-white p-8 border border-gray-300 shadow-lg rounded-lg">
            ...
            <p><strong>Ad:</strong> <?php echo htmlspecialchars($user['firstname']); ?></p>
            <p><strong>Soyad:</strong> <?php echo htmlspecialchars($user['lastname']); ?></p>
            <p><strong>Twitter:</strong> <?php echo htmlspecialchars($user['twitter']); ?></p>
            <p><strong>Instagram:</strong> <?php echo htmlspecialchars($user['instagram']); ?></p>
        </div>
    </div>
</body>
</html>